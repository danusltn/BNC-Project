...
import bnc.tech.myapplication.domain.dataSource.MovieDetailDataSourceFactory
...
class MovieDetailViewModel @Inject constructor(
    private val dataSourceFactory: MovieDetailDataSourceFactory
) : BaseViewModel<PagedList<Models.MovieDetailResponse>>() {
