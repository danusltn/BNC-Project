...
) : SingleUseCase<BaseModel<Models.MovieResponse>, MovieModel>(useCaseExecutor, postExecutionThread, repository) {
    override fun interact(params: MovieModel): Single<BaseModel<Models.MovieResponse>> {
        return repository.getMovieUseCase(params)
    }
}