...
import bnc.tech.myapplication.domain.interactor.GetMovieUseCase
...
class MoviePositionalDataSource @Inject constructor(
    private val getMovieUseCase: GetMovieUseCase
) : PositionalDataSource<Models.MovieResponse>(), Disposable {
...
//    }
    ...
    private fun loadRangeInternal(startPosition: Int, loadCount: Int) {
        ...
        val disposable = getMovieUseCase.execute(MovieModel(filter)).subscribe({ response ->
    ...
    override fun loadRange(params: LoadRangeParams, callback: LoadRangeCallback<Models.MovieResponse>) {
    ...
    override fun loadInitial(params: LoadInitialParams, callback: LoadInitialCallback<Models.MovieResponse>) {
        val totalCount = 2000
